...
// 3 matrix multiplication functions for different size matrices
    ...
    for (int i = 0; i < SIZE_1; i++) {
        for (int j = 0; j < SIZE_1; j++) {
            ...
            for (int k = 0; k < SIZE_1; k += 8) {
                //take 8 elements from matrix a
                __m256i row = _mm256_loadu_si256((__m256i *)&arr[i][k]);
                //take 8 elements from matrix b
...
int main(void) {
    ...
    printf("10x10 matrix multiplication : Time taken for execution : %f \n", time_taken);
    ...
    printf("100x100 matrix multiplication: elements Time taken for execution : %f \n", time_taken);
    ...
    time_taken = ((double)end - start) / CLOCKS_PER_SEC;
    printf("1000x1000 matrix multiplication: elements Time taken for execution : %f \n", time_taken);
